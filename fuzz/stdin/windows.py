...
class GenericWindowsFuzzer(Fuzzer):

	def __init__(self, ID, queue):
		super(GenericWindowsFuzzer, self).__init__(ID, queue)
		self.name = 'generic windows input fuzzer'
		# Read in the format string attacks
		f = open('./fuzz/fuzzdb/attack/all-attacks/all-attacks-win.txt')
